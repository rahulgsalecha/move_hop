    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JSONObject json = sr.getJSON("http://10.154.161.54:8080/login",params);
                if(json != null){
                try{
                ...
                cont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                      ...
                      //  JSONObject json = sr.getJSON("http://192.168.56.1:8080/api/resetpass", params);
                        JSONObject json = sr.getJSON("http://10.154.161.54:8080/api/resetpass", params);
                            ...
                            try {
                                ...
                                cont_code.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        JSONObject json = sr.getJSON("http://10.154.161.54:8080/api/resetpass/chg", params);
